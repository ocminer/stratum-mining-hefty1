...
COINDAEMON_TRUSTED_PORT = 13033
COINDAEMON_TRUSTED_USER = 'rpc'
COINDAEMON_TRUSTED_PASSWORD = 'rpc'

COINDAEMON_ALGO = 'heavy'    # The available options are:  scrypt, sha256d, scrypt-jane, skeinhash, and quark
SCRYPTJANE_NAME = 'vtc-scrypt'# Set this to the Scrypt jane module name e.g. yac_scrypt or vtc_scrypt
...
INVALID_SHARES_PERCENT = 80     # Allow average invalid shares vary this % before we ban
